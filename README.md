...
# RMC Reactive Extensions

This is an RMC fork of the Reactive Extensions library from https://github.com/Cysharp/R3.
...
```json
{
  ...
  "dependencies": {
    "com.rmc.rmc-reactive-extensions": "0.0.1"
  }
}
```
...
{
  "dependencies": {
    "com.rmc.rmc-reactive-extensions": "https://github.com/SamuelAsherRivello/rmc-reactive-extensions.git"
  }
}
```
...
{
  "dependencies": {},
  "testables": ["com.rmc.rmc-reactive-extensions"]
}
```
